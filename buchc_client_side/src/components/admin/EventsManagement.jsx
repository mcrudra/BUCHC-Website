...
import { Edit2, Loader2, Trash2, MoreVertical } from "lucide-react";
  ...
  return (
    <AdminLayout>
      <div className="max-w-7xl mx-auto w-full">
        ...
        {showForm && (
          <div className="relative bg-white p-4 sm:p-6 rounded-lg shadow mb-6">
            {saving && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-4">
                <button
                  type="submit"
                  disabled={saving}
                  className="inline-flex items-center gap-2 bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              if (
                                ...
                                buttonRect.bottom > window.innerHeight * 0.6
                              ) {
                                // Open upward
                                setDropdownPosition({
