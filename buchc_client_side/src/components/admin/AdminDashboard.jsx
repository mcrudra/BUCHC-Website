    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-black">Welcome to BUCHC Admin Panel</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="text-3xl font-bold text-black">{stats.events}</div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <h3 className="text-black text-sm font-medium mb-1">Top Players</h3>
            <div className="text-3xl font-bold text-black">{stats.players}</div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="text-3xl font-bold text-black">{stats.teams}</div>
          </div>
        </div>
