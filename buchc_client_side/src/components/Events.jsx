      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 sm:mb-20">
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            <h3 className="text-gray-900 text-2xl sm:text-3xl">
              Upcoming Events
            </h3>
              ...
              {upcomingEvents.map((event, index) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6">
                    <h4 className="text-gray-900 text-lg sm:text-xl mb-3 sm:mb-4">
                      {event.title}
                    </h4>
                    {event.desc && (
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                {selectedEvent.date && (
                  <div className="flex items-center gap-2 sm:gap-3 text-gray-700 text-sm sm:text-base">
                    <Calendar
                      size={18}
                      className="sm:w-5 sm:h-5 text-blue-600 flex-shrink-0"
                    />
